(function(){
  ...
  */  
  ...
  function showOperationMessage( n1, operator, n2) {
  ...
  */
  ...
  if( sum ) {
    n1 = 10;
    n2 = 20;
    console.log( showOperationMessage( n1, operationSignal, n2 ), sum( n1, n2 ) );
  }
  ...
  */
  ...
  if( subtraction ) {
    n1 = 60;
    n2 = 20;
    console.log( showOperationMessage( n1, operationSignal, n2 ), subtraction( n1, n2 ) );
  } else {
  ...
  if( multiplication ) {
    n1 = 9;
    n2 = 183;
    console.log( showOperationMessage( n1, operationSignal, n2 ), multiplication( n1, n2 ) );
  } else {
    console.log( showErrorMessage( operationSignal ) );
  }
  ...
  if( division ) {
    n1 = 200;
    n2 = 5;
    console.log( showOperationMessage( n1, operationSignal, n2 ), division( n1, n2 ) );
  } else {
    console.log( showErrorMessage( operationSignal ) );
  }
  ...
  if( mod ) {
    n1 = 50;
    n2 = 3;
    console.log( showOperationMessage( n1, operationSignal, n2 ), mod( n1, n2 ) );
  } else {
    console.log( showErrorMessage( operationSignal ) );
  }
  ...
  */
  ...
  operationSignal = 'bilu';
  var invalid = calculator( operationSignal );
  if( invalid ) {
    n1 = 50;
    n2 = 3;
    console.log( showOperationMessage( n1, operationSignal, n2 ), invalid( n1, n2 ) );
  } else {
    console.log( showErrorMessage( operationSignal ) );
  }
